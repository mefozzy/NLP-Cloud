...
public class Phrase_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ru.misis.asu.nlp.npr.types.Phrase");
  ...
  public int getHead(int addr) {
      ...
      jcas.throwFeatMissing("head", "ru.misis.asu.nlp.npr.types.Phrase");
  ...
  public int getDependents(int addr) {
      ...
      jcas.throwFeatMissing("dependents", "ru.misis.asu.nlp.npr.types.Phrase");
  ...
  public Phrase_Type(JCas jcas, Type casType) {
    ...
    casFeat_head = jcas.getRequiredFeatureDE(casType, "head", "ru.misis.asu.nlp.morphoanalysis.types.Word", featOkTst);
